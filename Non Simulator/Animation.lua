            ...
            if swingAnimationsFolder then
                ...
                if humanoid then
                    ...
                    if #animationplaying > 0 then
                        ...
                        print("No animation tracks found on the closest player.")
                    end
                end
            else
                print("Tool 'SwingAnimations' folder not found inside the closest player's character.")
            end
        else
            print("Tool not found inside the closest player's character.")
        end
    else
        print("Humanoid not found inside the closest player's character.")
    end
else
    print("Closest player not found.")
end
