...
local Section = T5:CreateSection("BoxHandleAdornment")

local Toggle = T5:CreateToggle({
    Name = "Esp Coal (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
...
local Toggle = T5:CreateToggle({
    Name = "Esp Copper (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
...
local Toggle = T5:CreateToggle({
    Name = "Esp Gold (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
...
local Toggle = T5:CreateToggle({
    Name = "Esp Iron (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
...
local Toggle = T5:CreateToggle({
    Name = "Esp Limestone (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
...
local Toggle = T5:CreateToggle({
    Name = "Esp Silver (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
...
local Toggle = T5:CreateToggle({
    Name = "Esp Zinc (BoxHandleAdornment)",
    CurrentValue = false,
    Flag = "Toggle1",
    Callback = function(Value)
        if Value == true then
