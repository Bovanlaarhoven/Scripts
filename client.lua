...
mouse.move:Connect(function()
	...
	for i,v in pairs(game.Players:GetPlayers()) do
        ...
        if closestplr then
            Gui.Name = "Gui"
            Gui.Parent = game.Players.LocalPlayer:WaitForChild("CoreGui")
            ...
            MaxHealth.Text = math.floor("/"..closestplr.Character.Humanoid.MaxHealth)
            ...
            RigType.Text = closestplr.Character.Humanoid.RigType..""
            ...
            WalkSpeed.Text = math.floor(closestplr.Character.Humanoid.WalkSpeed.."")
            ...
            JumpPower.Text = math.floor(closestplr.Character.Humanoid.JumpPower.."")
            ...
            Bar.Position = UDim2.new(0.409541517, 0, 0.0829074457, 0)
            ...
            Hp.Position = UDim2.new(0.409541517, 0, 0.0829074457, 0)
